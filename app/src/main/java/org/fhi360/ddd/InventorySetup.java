...
public class InventorySetup extends AppCompatActivity implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    private SetupAdapter mCardAdapter;
