...
public class ReportingPeriod extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemSelectedListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), OutletRoutineNationalReport.class);
    ...
    @Override
    public void onClick(View view) {
        Intent intent = new Intent(this, ServiceSummaryActivity2.class);
