...
public class OutletRecievedAndRequest extends AppCompatActivity implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    private InventoryPagerAdapter mCardAdapter;
