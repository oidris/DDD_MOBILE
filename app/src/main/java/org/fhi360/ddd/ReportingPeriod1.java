...
public class ReportingPeriod1 extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemSelectedListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_reporting_period1);
