...
//                        String pin = account.getString("pin_code");
//                        Account id = DDDDb.getInstance(context).pharmacistAccountRepository().findByCommunityPin(pin);
//                        if (id != null) {
//                            Account account1 = new Account();
//                            account1.setAddress(address);
//                            account1.setId(id.getId());
//                            account1.setPharmacy(pharmacy);
//                            account1.setPhone(phone);
//                            account1.setEmail(email);
//                            account1.setPinCode(pin);
//                            DDDDb.getInstance(context).pharmacistAccountRepository().update(account1);
//                        } else {
//                            Account account1 = new Account();
//                            account1.setAddress(address);
//                            account1.setPharmacy(pharmacy);
...
//                            account1.setEmail(email);
//                            account1.setPinCode(pin);
//                            DDDDb.getInstance(context).pharmacistAccountRepository().save(account1);
//                        }
//                    }
//                }
...
//                }
                ...
                if (patients != null) {
                    for (int i = 0; i < patients.length(); i++) {
                        ...
                        String facilityName = patient.getString("facility_name");
                        ...
                        String dateBirth = patient.getString("date_birth").isEmpty() ? null : patient.getString("date_birth");
                        ...
                        String dateStarted = patient.getString("date_started");
...
//                        String regimen = patient.getString("regimen");
                        ...
                        String dateLastViralLoad = patient.getString("date_last_viral_load").isEmpty() ? null :patient.getString("date_last_viral_load");
                        String viralLoadDueDate = patient.getString("viral_load_due_date").isEmpty() ? null : patient.getString("viral_load_due_date");
                        String viralLoadType = patient.getString("viral_load_type");
                        String dateLastRefill = patient.getString("date_last_refill").isEmpty() ? null : patient.getString("date_last_refill");
                        String dateNextRefill = patient.getString("date_next_refill").isEmpty() ? null :patient.getString("date_next_refill");
                        String dateLastClinic = patient.getString("date_last_clinic").isEmpty() ? null : patient.getString("date_last_clinic");
                        String dateNextClinic = patient.getString("date_next_clinic").isEmpty() ? null : patient.getString("date_next_clinic");
//check for list
                        Patient id = DDDDb.getInstance(context).patientRepository().findByPatient(patientId);
                        if (id != null) {
                            Patient patient1 = new Patient();
                            patient1.setId(id.getId());
                            patient1.setFacilityName(facilityName);
                            ...
                            patient1.setDateBirth(dateBirth);
                            patient1.setAddress(address);
                            patient1.setPhone(phone);
                            patient1.setDateStarted(dateStarted);
                            patient1.setLastClinicStage(lastClinicStage);
                            patient1.setLastViralLoad(lastViralLoad);
                            patient1.setDateLastViralLoad(dateLastViralLoad);
                            patient1.setViralLoadDueDate(viralLoadDueDate);
                            patient1.setViralLoadType(viralLoadType);
                            patient1.setDateLastClinic(dateLastClinic);
                            patient1.setDateNextClinic(dateNextClinic);
                            patient1.setDateLastRefill(dateLastRefill);
                            patient1.setDateNextRefill(dateNextRefill);
                            patient1.setRegimen("regimen");
                            patient1.setRegimenType("regimentype");
                            patient1.setStatus(0);
...
//
//                        Devolve id = DDDDb.getInstance(context).devolveRepository().findByOne(facilityId, patientId, dateDevolved.toString());
//                        if (id != null) {
//                            Devolve devolve1 = new Devolve();
//                            devolve1.setId(id.getId());
//                            devolve1.setFacilityId(facilityId);
//                            devolve1.setPatientId(patientId);
//                            devolve1.setDateDevolved(dateDevolved);
//                            devolve1.setViralLoadAssessed(viralLoadAssessed);
//                            devolve1.setLastViralLoad(lastViralLoad);
//                            devolve1.setDateLastViralLoad(dateLastViralLoad);
//                            devolve1.setCd4Assessed(cd4Assessed);
//                            devolve1.setLastCd4(lastCd4);
//                            devolve1.setDateLastCd4(dateLastCd4);
//                            devolve1.setLastClinicStage(lastClinicStage);
//                            devolve1.setDateLastClinicStage(dateLastClinicStage);
//                            devolve1.setArvDispensed(arvDispensed);
//                            devolve1.setRegimentype(regimentype);
//                            devolve1.setRegimen(regimen);
//                            devolve1.setDateLastClinic(dateLastClinic);
//                            devolve1.setDateNextClinic(dateNextClinic);
//                            devolve1.setDateLastRefill(dateLastRefill);
//                            devolve1.setDateNextRefill(dateNextRefill);
//                            devolve1.setNotes(notes);
//                            devolve1.setDateDiscontinued(dateDiscontinued);
//                            devolve1.setReasonDiscontinued(reasonDiscontinued);
//                            DDDDb.getInstance(context).devolveRepository().update(devolve1);
//                        } else {
//                            Devolve devolve1 = new Devolve();
//                            devolve1.setFacilityId(facilityId);
//                            devolve1.setPatientId(patientId);
...
//                            devolve1.setDateDiscontinued(dateDiscontinued);
//                            devolve1.setReasonDiscontinued(reasonDiscontinued);
//                            DDDDb.getInstance(context).devolveRepository().save(devolve1);
//                        }
//                    }
 //               }
            }
