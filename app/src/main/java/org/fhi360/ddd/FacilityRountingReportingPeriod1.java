...
public class FacilityRountingReportingPeriod1 extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemSelectedListener {
    ...
    @Override
    public void onClick(View view) {
        Intent intent = new Intent(this, ServiceSummaryFacilityNational.class);
